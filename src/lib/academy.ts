...
export const LESSONS: Lesson[] = [
  ...
  { n: 67, tag: "CRYPTO", truth: "BOTH", rank: "Senior Grinder", xp: 260, title: "Stack kBTC On the Toilet",
    body: "Bridge BTC to Ink as kBTC from the throne. The seat is cold storage. The grind is self-custody. The flush is confirmation." },
  { n: 68, tag: "CRYPTO", truth: "HALF TRUE", rank: "Senior Grinder", xp: 280, title: "The ETH Ladder",
    body: "DCA into ETH every Friday at 16:58. Reply-All Sigma Hour funds the bag. The bell rings. You buy. You ghost. The chart obeys." },
  ...
  { n: 78, tag: "CRYPTO", truth: "HALF TRUE", rank: "INKO Himself", xp: 1850, title: "Future Gen: Privacy Is The Future",
  ...
  { n: 79, tag: "CRYPTO", truth: "HALF LIE", rank: "Apprentice Grinder", xp: 80, title: "The DexScreener Tab",
  ...
  { n: 80, tag: "CRYPTO", truth: "HALF TRUE", rank: "Senior Grinder", xp: 300, title: "LP Lock Bragging Rights",
